    ...
    <div class="container">
      <div class="footer__box">
        <div class="footer__part">
          ...
          >
            <rect width="126" height="50" fill="url(#pattern0_1_17)" />
            <defs>
              <pattern
                id="pattern0_1_17"
              ...
              >
                <use
                  xlink:href="#image0_1_17"
                  transform="matrix(0.00336293 0 0 0.00847458 -0.00443906 0)"
                />
              </pattern>
              <image
                id="image0_1_17"
        ...
        <div class="footer__part">
          <h3 class="footer__part-title">Contact Alowishus!</h3>
          <a href="" class="footer__part-contacts"
            ><i class="pi pi-envelope" style="font-size: 1rem"></i>
            alowishus@gmai.com</a
          >
          <a href="" class="footer__part-contacts"
            ><i class="pi pi-phone" style="font-size: 1rem"></i> +110 214 214
            2451</a
          >
          <div class="footer__part-links">
            <a href="" class="footer__part-contacts">
        ...
        <div class="footer__part">
          <h3 class="footer__part-title">Store Locations</h3>
          <p class="footer__part-txt">
            Find your nearest Alowishus store with opening hours, location and
            contact details.
          </p>
          <a href="" class="footer__part-find"
            >Find my Alowishus <i class="pi pi-arrow-right"></i
          ></a>
        </div>
        <div class="footer__part">
          <h3 class="footer__part-title">Store Locations</h3>
          <input type="email" class="footer__part-email" placeholder="E-mail" />
          <subscribe-btn />
        </div>
      </div>
      <div class="footer__end">
        <p class="footer__end-txt">
          Copytright © 2022 <span>Alowishus Delicious</span>
        </p>
        <p class="footer__end-txt">Terms of Use | Privacy Policy</p>
      </div>
    </div>
  </footer>
</template>
